  ...
  return function () {
    ...
    function w(t, n) {
      ...
      return (
        (o = U(t, F[(e = n)])),
        (r[e] = o),
        (s[e] = e === B ? o : 0 <= o ? N(o, G[e]) : G[e] - N(o, G[e])),
        r[n] !== i
      );
    }
    function t() {
      n(),
        (function () {
          for (var t in s)
            s.hasOwnProperty(t) && "number" == typeof s[t] && (s[t] = 0);
          for (var n in r)
            r.hasOwnProperty(n) && "number" == typeof r[n] && (r[n] = 0);
        })();
    }
    function n() {
    ...
    function g(t) {
      ...
      M()
        ? ((y = E()), (l = V(h.target)))
        : ((c =
            "string" == typeof (e = (e = t) || {}).precision ? e.precision : O),
          (f = "function" == typeof e.callback ? e.callback : function () {}),
          (m = !0 === e.countdown),
          (a = !0 === m ? -1 : 1),
          "object" === q(e.startValues)
            ? ((o = e.startValues),
              (p = L(o)),
              (s.secondTenths = p[0]),
              (s.seconds = p[1]),
          ...
          "object" === q(e.target)
            ? (l = V(e.target))
            : m
            ? ((e.target = { seconds: 0 }), (l = V(e.target)))
            : (l = null),
          (v = {
            precision: c,
            callback: f,
          ...
          (h = e)),
        (n = F[c]),
        C(j(Date.now())) || ((i = setInterval(T, n)), (d = !(u = !0)));
    }
    function E() {
    ...
    function T() {
      var t,
        n = j(Date.now());
      (t = S())[I] && k("secondTenthsUpdated", b),
        t[O] && k("secondsUpdated", b),
        t[z] && k("minutesUpdated", b),
        t[R] && k("hoursUpdated", b),
        t[B] && k("daysUpdated", b),
        f(b.detail.timer),
        C(n) && (D(), k("targetAchieved", b));
    }
    function S() {
      var t =
    ...
    function L(t) {
      var n,
        ...
        s,
        r = void 0;
      if ("object" === (void 0 === t ? "undefined" : q(t)))
